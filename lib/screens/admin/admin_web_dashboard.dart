...
// 🔥 الاستيرادات النسبية النظيفة (لا تغيرها أبداً لكي لا يحدث تعارض)
import 'admin_dashboard_screen.dart';
import 'customer_orders_review_screen.dart';
import 'agenda_screen.dart';
import 'daily_manifest_screen.dart';
import 'logistics_management_screen.dart';
import 'master_tracking_screen.dart';
import 'admin_fleet_screen.dart';
import 'admin_expense_review_screen.dart';
import 'sales_ledger_screen.dart';
import 'sales_management_screen.dart';
import 'admin_b2b_pricing_screen.dart';
import 'customer_prices_screen.dart';
...
class _AdminWebDashboardState extends State<AdminWebDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          // =========================================================
          // 1. Sidebar (قائمة التحكم الجانبية المرنة)
          // =========================================================
          Container(
            width: 280,
            color: darkBlue,
            child: Column(
              children: [
                ...
                // 🔥 استخدام Expanded لمنع أي خطأ Overflow في الشاشات الصغيرة
                Expanded(
                  child: ListView(
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.1), blurRadius: 10, offset: const Offset(-5, 0))] // 🔥 تم التحديث
              ),
              child: ClipRRect(
                borderRadius: const BorderRadius.only(topLeft: Radius.circular(30), bottomLeft: Radius.circular(30)),
  ...
  Widget _buildNavItem(IconData icon, String title, int index) {
    ...
    // 🔥 تم تحديث الزر ليكون أصغر حجماً وأكثر احترافية لمنع الـ Overflow
    return ListTile(
      selected: isSelected,
      selectedTileColor: primaryRed.withValues(alpha: 0.9), // 🔥 تم التحديث
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
      contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 0),
      visualDensity: const VisualDensity(horizontal: 0, vertical: -2), // لتقليل المسافة بين الأزرار
